		...
		<div class="row py-5 mt-4 align-items-center">
			...
			<center>
				<div class="col-md-5 col-lg-10 ml-auto">
					...
					<div style="width: 50%;">
						<form class="row g-2" action="gpassword.php" method="post">
							<div class="form-floating mb-3">
								<input type="Password" class="form-control" id="floatingInput" placeholder="contoh : kursi" name="plama" maxlength="100">
								<label for="floatingInput">Password Lama</label>
							</div>
							<div class="form-floating mb-3">
								<input type="Password" class="form-control" id="floatingInput" placeholder="contoh : kursi" name="pbaru" maxlength="100">
								<label for="floatingInput">Password Baru</label>
							</div>
							<div class="form-floating mb-3">
								<input type="Password" class="form-control" id="floatingInput" placeholder="contoh : kursi" name="pkon" maxlength="100">
								<label for="floatingInput">Konfirmasi Password</label>
							</div>
							<div class="mt-3">
								<div class="col-md-12">
									<center>
										<button type="submit" name="ganti" class="btn btn-outline-primary" onclick="return confirm('Apakah Anda yakin?')">Ganti</button>
									</center>
								</div>
							</div>
						</form>
