...
<body style="background: url(../gambar/bggbr.jpg); background-size: cover; background-repeat: no-repeat;">
	...
	<div class="container" style="background-color: white;	 border-radius: 30px; width: 80%;">
		<div class="row py-5 mt-4 align-items-center">
			...
			<center>
				<h1 class="mb-1">Asisten</h1>
			</center>
			<div class="ms-5 mb-3">
				<a href="tambah_user.php"><button type="button" class="btn btn-outline-primary btn-sm mt-1 ms-5">Tambah Asisten</button></a>
			</div>
			<center>
						...
						<tbody>
							...
							while ($tampil = mysqli_fetch_array($query)) {
								...
								<tr>
									...
									<td><center><img src="../gambar/<?php echo $tampil['foto']; ?>" style="width: 50px; height: 50px; border-radius: 30px;"></center></td>
									<td>
										<center>
											<a href="asisten.php?no_anggota=<?php echo $tampil['no_anggota']; ?>"><button type="button" class="btn btn-outline-danger btn-sm mt-1" onclick="return confirm('Apakah Anda yakin menghapus data ini? semua data yang berkaitan akan hilang!!')">Hapus</button></a>
										</center>
									</td>
								</tr>
